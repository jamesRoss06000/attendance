...
export class AuthService {
  ...
  getUserDetails(email, password) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/auth.php', {
      email,
      password,
    }).subscribe(data => {
      ...
      if (user[5] == 'etudiant') {
        return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/calendarStudent.php', {
          id
        }).subscribe(data => {
  ...
  getCalendarDates(id) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/calendarTeacher.php', {
      id
    }).subscribe(data => {
  ...
  getCoursList(date, idIntervenant) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/getCours.php?id=' + idIntervenant, {
      date,
    }).subscribe(data => {
      console.log(Object.values(data));
      let planningData = Object.values(data);
  ...
  getStudentList(id, date, id_planning) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/getStudentNames.php?id=' + id, {
      date,
      id,
      id_planning
    }).subscribe(data => {
  ...
  updateAbsenceDb(planning_id, classe, id, etudiant_nom, etudiant_id) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/updateAbsenceDb.php?id=' + id, {
      planning_id,
      classe,
      id,
      etudiant_nom,
  ...
  getStudentCours(date, id) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/getStudentCours.php?id=' + id, {
      date,
    }).subscribe(data => {
      console.log(Object.values(data));
      let planningData = Object.values(data);
  ...
  getRdvInfo(id) {
    return this.http.post('http://192.168.43.223/Attendance App/myApp/src/app/api/getRdvInfo.php?id=' + id, {
      id
    }).subscribe(data => {
      console.log(Object.values(data));
